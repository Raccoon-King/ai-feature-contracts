# Feature Contract: Project Baseline for React application
...
## Objective
Capture the repository baseline for this react application so future feature contracts can stay aligned with the detected structure and tooling.
...
- Primary dependency signals: `chokidar`, `cli-progress`, `yaml`, `jest`
...
- Root signals considered: `agents/`, `AGENTS.md`, `bin/`, `CLAUDE.md`, `contracts/`, `docs/`, `examples/`, `grabby.config.example.json`
