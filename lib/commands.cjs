...
function createCommandHandlers({
  ...
  async function performRulesetSyncCheck(commandName, contractPath = null) {
    const { performSyncCheck, updateContractDriftCheck } = require('./contract-rulesets.cjs');
    ...
    try {
      ...
      // Block if strict mode detected drift
...
`;
  ...
  async function execute(file, options = {}) {
    ...
    // Perform ruleset sync check before execution
