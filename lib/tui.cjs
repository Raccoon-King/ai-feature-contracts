...
function createMenu(options = {}) {
  ...
  const render = () => {
    ...
    console.log('');
    console.log(`${DIM}  Up/Down Navigate  |  Enter Select  |  Esc Back  |  q Quit${RESET}`);
  };
    ...
    const menu = createMenu({
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Install the latest Grabby release globally (with confirmation)',
          action: 'update-apply',
        },
        {
          label: 'Finish Setup',
