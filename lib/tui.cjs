...
function createTUI(context) {
  ...
  function mainMenu() {
    const menu = createMenu({
      ...
      header: getHeader(),
      items: [
        { label: 'List Contracts', description: 'View all active contracts', action: 'list' },
        { label: 'Setup Wizard', description: 'Configure Grabby for this repository', action: 'setup' },
        { label: 'Create Contract', description: 'Start work with guided Grabby intake', action: 'create' },
        { label: 'Validate All', description: 'Check all contracts quickly', action: 'validate' },
        { label: 'View Metrics', description: 'Show contract statistics', action: 'metrics' },
        { label: 'Watch Mode', description: 'Auto-validate on changes', action: 'watch' },
        { label: 'CI/CD Setup', description: 'Review automation status', action: 'cicd' },
        ...
        { label: 'Ruleset Wizards', description: 'Import or create repository rulesets', action: 'rulesets' },
